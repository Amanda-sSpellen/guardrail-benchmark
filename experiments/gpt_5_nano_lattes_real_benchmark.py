...
async def main(
        ...
        output_dir = "results/gpt_5_nano_lattes_real",
        experiment_name = "gpt_5_nano_lattes_real_benchmark",
        dataset_name = "PTBRAcademicDataset",
        dataset_path = "data/ptbr_real_academic_questions.json",
...
if __name__ == "__main__":
    ...
    # load_and_plot(
    #     result_path="results/openai_ptbr/000/000_openai_ptbr_benchmark_predictions_metadata_20260224_202102.json", 
